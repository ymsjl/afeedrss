...
const mockHandlers = [
  http.get(`${readerBaseUrl}/subscription/edit`, function (...args) {
  ...
  http.get(`${readerBaseUrl}/subscription/list`, getSubscriptionListMock),
  http.get(`${readerBaseUrl}/tag/list`, getFolderOrTagListMock),
];
